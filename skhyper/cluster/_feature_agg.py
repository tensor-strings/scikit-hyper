...
"""
import numpy as np
from sklearn.cluster import FeatureAgglomeration as _sklearn_feature_agg
...
class FeatureAgglomeration:
    ...
    """
    def __init__(self, n_clusters, init="agglomerate++", affinity='euclidean',
    ...
    def fit(self, X):
        ...
        mdl = _sklearn_feature_agg(n_clusters=self.n_clusters, affinity=self.affinity, memory=self.memory,
